...
*/
  ...
  MTensor* tensor2 = act->GetOutPut(tensor1);

  const MShape shape2 = tensor2->GetShape();
  cout<<shape2[0]<<" "<<shape2[1]<<endl;

  ifstream in_txt1("/gpfs/mnt/gpfs02/phenix/mpcex/liankun/Run16/Ana/offline/analysis/mpcexcode/MpcEx_CNN/Test/MConv2D/out_matrix_keras_conv2d_ft2x2_stride1_pad_same_activation_softmax.txt");
