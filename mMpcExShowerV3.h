#ifndef __MMPCEXSHOWERV3_HH__
#define __MMPCEXSHOWERV3_HH__
...
#define EXPANSION_START 1.1 //original 1.3
#define FRACTIONAL_ENERGY_LIMIT 0.05 // orignial 0.02
#define EXP_FACTOR_LIMIT 2.0 // original 4

class mMpcExShowerV3: public SubsysReco
{
 public:

  mMpcExShowerV3( const char* name = "MMPCEXSHOWERV3" );
  virtual int Init(PHCompositeNode*);
  virtual int InitRun(PHCompositeNode*);
  virtual int process_event(PHCompositeNode*);
  virtual ~mMpcExShowerV3();
  virtual int End(PHCompositeNode *topNode);

  void EnableSTReco() {DoSTReco = 1; std::cout << "mMpcExShowerV3: single track reconstruction enabled" << std::endl;}
  void DisableSTReco() {DoSTReco = 0; std::cout << "mMpcExShowerV3: single track reconstruction disabled" << std::endl;}

  void EnableSouthReco() {DisableSouth = 0; std::cout << "mMpcExShowerV3: south arm reconstruction enabled" << std::endl;}
  void DisableSouthReco() {DisableSouth = 1; std::cout << "mMpcExShowerV3: south arm reconstruction disabled" << std::endl;}

  void EnableNorthReco() {DisableNorth = 0; std::cout << "mMpcExShowerV3: north arm reconstruction enabled" << std::endl;}
  void DisableNorthReco() {DisableNorth = 1; std::cout << "mMpcExShowerV3: north arm reconstruction disabled" << std::endl;}
