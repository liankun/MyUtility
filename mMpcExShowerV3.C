...
mMpcExShowerV3::mMpcExShowerV3( const char* name ) : 
  SubsysReco( name )
{
  _vertex = -9999.0;
  _t0 = -9999.0; 
...
//_______________________________________________________
// destructor
int mMpcExShowerV3::End(PHCompositeNode *topNode)
{
  return EVENT_OK;
}
...
//_______________________________________________________
// initialization
int mMpcExShowerV3::Init(PHCompositeNode* top_node)
{
...
int mMpcExShowerV3::InitRun(PHCompositeNode* top_node)
{
...
void mMpcExShowerV3::set_interface_ptrs(PHCompositeNode* top_node)
{
...
//_______________________________________________________
// Event method.
int mMpcExShowerV3::process_event(PHCompositeNode* top_node)
{
...
bool  mMpcExShowerV3::FindShowers(PHCompositeNode* top_node)
{
  ...
  for(; itr!=itr_end; ++itr){
	...
	if((fabs(seed_shx-prev_seed_shx)<=HOUGH_CONVERGE) || 
	  ...
	  Stage1Complete = true; 
	  ExpansionFactor = EXPANSION_START; 
	...
	if( (frac_gain<FRACTIONAL_ENERGY_LIMIT) || (ExpansionFactor>=EXP_FACTOR_LIMIT)){
	  Stage2Complete = true; 
...
void  mMpcExShowerV3::MergeShowers(TMpcExShower *main, TMpcExShower *splinter)
{
...
void  mMpcExShowerV3::CalculateShowerProperties(TMpcExShower *shower_v1){
...
void  mMpcExShowerV3::SingleTrackReco()
{
...
void mMpcExShowerV3::getMPC_TwrSum(int arm, double shx, double shy, int &iMPCTwr_peak, double MPCE[5][5], 
...
void mMpcExShowerV3::MatchMPC(int arm, double fMPCEXHoughX, double fMPCEXHoughY, float &fMPC_dhough, 
